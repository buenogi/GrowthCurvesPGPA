...
plot1 <- ggplot(REF_C0, aes(x = fitted(REF_C0_G4), y = abs)) +
...
plot1 <- ggplot(C76_C0, aes(x = fitted(C76_C0_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C0, aes(x = fitted(C76_C0_G4), y = residuals(C76_C0_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C0, aes(sample = residuals(C76_C0_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C0, aes(x = fitted(C67_C0_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot1 <- ggplot(C68_C0, aes(x = fitted(C68_C0_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C0, aes(x = fitted(C68_C0_G4), y = residuals(C68_C0_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C0, aes(sample = residuals(C68_C0_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(REF_C10, aes(x = fitted(REF_C10_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " REF - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(REF_C10, aes(x = fitted(REF_C10_G4), y = residuals(REF_C10_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "REF - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(REF_C10, aes(sample = residuals(REF_C10_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C76_C10, aes(x = fitted(C76_C10_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C10, aes(x = fitted(C76_C10_G4), y = residuals(C76_C10_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C10, aes(sample = residuals(C76_C10_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C10, aes(x = fitted(C67_C10_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C67_C10, aes(x = fitted(C67_C10_G4), y = residuals(C67_C10_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C67 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C67_C10, aes(sample = residuals(C67_C10_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C68_C10, aes(x = fitted(C68_C10_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C10, aes(x = fitted(C68_C10_G4), y = residuals(C68_C10_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C10, aes(sample = residuals(C68_C10_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
REF_C50_G4 <- drm(abs~tempo, data = REF_C50 , fct =  G.4())
plot(REF_C50_G4, 
     broken = TRUE, gridsize = 100, xlab = "Tempo(dias)", 
     ylab = "Abs", type = "all")
summary(REF_C50_G4)

C76_C50_G4 <- drm(abs~ tempo, data = C76_C50 , fct =  G.4())
plot(C76_C50_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C67_C50_G4 <- drm(abs~ tempo, data = C67_C50 , fct =  G.4())
plot(C67_C50_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C68_C50_G4 <- drm(abs~ tempo, data = C68_C50 , fct =  G.4())
plot(C68_C50_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

# C50 analysis

newdata_REF_C50 <- expand.grid(tempo = seq(min(REF_C50$tempo), max(REF_C50$tempo), length.out = 200))
newdata_REF_C50$abs <- predict(REF_C50_G4, newdata_REF_C50, type = 'response')
newdata_REF_C50$pop <- "REF"

newdata_C76_C50 <- expand.grid(tempo = seq(min(C76_C50$tempo), max(C76_C50$tempo), length.out = 200))
newdata_C76_C50$abs <- predict(C76_C50_G4, newdata_C76_C50, type = 'response')
newdata_C76_C50$pop <- "C76"

newdata_C67_C50 <- expand.grid(tempo = seq(min(C67_C50$tempo), max(C67_C50$tempo), length.out = 200))
newdata_C67_C50$abs <- predict(C67_C50_G4, newdata_C67_C50, type = 'response')
newdata_C67_C50$pop <- "C67"

newdata_C68_C50 <- expand.grid(tempo = seq(min(C68_C50$tempo), max(C68_C50$tempo), length.out = 200))
newdata_C68_C50$abs <- predict(C68_C50_G4, newdata_C68_C50, type = 'response')
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelREF <- summary(REF_C50_G4)
confintREF <- confint(REF_C50_G4)
modelREF_coef <- as.data.frame(modelREF$coefficients)
modelREF_conf <- as.data.frame(confintREF)
modelREF_SUM <- cbind(modelREF_coef, modelREF_conf)
modelREF_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC76 <- summary(C76_C50_G4)
confintC76 <- confint(C76_C50_G4)
modelC76_coef <- as.data.frame(modelC76$coefficients)
modelC76_conf <- as.data.frame(confintC76)
modelC76_SUM <- cbind(modelC76_coef, modelC76_conf)
modelC76_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <- c("GrowthRate", "c", "d","e")
modelC67 <- summary(C67_C50_G4)
confintC67 <- confint(C67_C50_G4)
modelC67_coef <- as.data.frame(modelC67$coefficients)
modelC67_conf <- as.data.frame(confintC67)
modelC67_SUM <- cbind(modelC67_coef, modelC67_conf)
modelC67_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC7 <- summary(C68_C50_G4)
confintC7 <- confint(C68_C50_G4)
modelC68_coef <- as.data.frame(modelC7$coefficients)
modelC68_conf <- as.data.frame(confintC7)
modelC68_SUM <- cbind(modelC68_coef, modelC68_conf)
modelC68_SUM$coef <- COEFICIENTS 
...
plot1 <- ggplot(REF_C50, aes(x = fitted(REF_C50_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " REF - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(REF_C50, aes(x = fitted(REF_C50_G4), y = residuals(REF_C50_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "REF - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(REF_C50, aes(sample = residuals(REF_C50_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C76_C50, aes(x = fitted(C76_C50_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C50, aes(x = fitted(C76_C50_G4), y = residuals(C76_C50_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C50, aes(sample = residuals(C76_C50_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C50, aes(x = fitted(C67_C50_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C67_C50, aes(x = fitted(C67_C50_G4), y = residuals(C67_C50_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C67 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C67_C50, aes(sample = residuals(C67_C50_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C68_C50, aes(x = fitted(C68_C50_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C50, aes(x = fitted(C68_C50_G4), y = residuals(C68_C50_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C50, aes(sample = residuals(C68_C50_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
REF_C75_G4 <- drm(abs~tempo, data = REF_C75 , fct =  G.4())
plot(REF_C75_G4, 
     broken = TRUE, gridsize = 100, xlab = "Tempo(dias)", 
     ylab = "Abs", type = "all")
summary(REF_C75_G4)

C76_C75_G4 <- drm(abs~ tempo, data = C76_C75 , fct =  G.4())
plot(C76_C75_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C67_C75_G4 <- drm(abs~ tempo, data = C67_C75 , fct =  G.4())
plot(C67_C75_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C68_C75_G4 <- drm(abs~ tempo, data = C68_C75 , fct =  G.4())
plot(C68_C75_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

# C75 analysis

newdata_REF_C75 <- expand.grid(tempo = seq(min(REF_C75$tempo), max(REF_C75$tempo), length.out = 200))
newdata_REF_C75$abs <- predict(REF_C75_G4, newdata_REF_C75, type = 'response')
newdata_REF_C75$pop <- "REF"

newdata_C76_C75 <- expand.grid(tempo = seq(min(C76_C75$tempo), max(C76_C75$tempo), length.out = 200))
newdata_C76_C75$abs <- predict(C76_C75_G4, newdata_C76_C75, type = 'response')
newdata_C76_C75$pop <- "C76"

newdata_C67_C75 <- expand.grid(tempo = seq(min(C67_C75$tempo), max(C67_C75$tempo), length.out = 200))
newdata_C67_C75$abs <- predict(C67_C75_G4, newdata_C67_C75, type = 'response')
newdata_C67_C75$pop <- "C67"

newdata_C68_C75 <- expand.grid(tempo = seq(min(C68_C75$tempo), max(C68_C75$tempo), length.out = 200))
newdata_C68_C75$abs <- predict(C68_C75_G4, newdata_C68_C75, type = 'response')
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelREF <- summary(REF_C75_G4)
confintREF <- confint(REF_C75_G4)
modelREF_coef <- as.data.frame(modelREF$coefficients)
modelREF_conf <- as.data.frame(confintREF)
modelREF_SUM <- cbind(modelREF_coef, modelREF_conf)
modelREF_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC76 <- summary(C76_C75_G4)
confintC76 <- confint(C76_C75_G4)
modelC76_coef <- as.data.frame(modelC76$coefficients)
modelC76_conf <- as.data.frame(confintC76)
modelC76_SUM <- cbind(modelC76_coef, modelC76_conf)
modelC76_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC67 <- summary(C67_C75_G4)
confintC67 <- confint(C67_C75_G4)
modelC67_coef <- as.data.frame(modelC67$coefficients)
modelC67_conf <- as.data.frame(confintC67)
modelC67_SUM <- cbind(modelC67_coef, modelC67_conf)
modelC67_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC7 <- summary(C68_C75_G4)
confintC7 <- confint(C68_C75_G4)
modelC68_coef <- as.data.frame(modelC7$coefficients)
modelC68_conf <- as.data.frame(confintC7)
modelC68_SUM <- cbind(modelC68_coef, modelC68_conf)
modelC68_SUM$coef <- COEFICIENTS 
...
plot1 <- ggplot(REF_C75, aes(x = fitted(REF_C75_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " REF - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(REF_C75, aes(x = fitted(REF_C75_G4), y = residuals(REF_C75_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "REF - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(REF_C75, aes(sample = residuals(REF_C75_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C76_C75, aes(x = fitted(C76_C75_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C75, aes(x = fitted(C76_C75_G4), y = residuals(C76_C75_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C75, aes(sample = residuals(C76_C75_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C75, aes(x = fitted(C67_C75_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C67_C75, aes(x = fitted(C67_C75_G4), y = residuals(C67_C75_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C67 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C67_C75, aes(sample = residuals(C67_C75_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C68_C75, aes(x = fitted(C68_C75_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C75, aes(x = fitted(C68_C75_G4), y = residuals(C68_C75_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C75, aes(sample = residuals(C68_C75_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
REF_C100_G4 <- drm(abs~tempo, data = REF_C100 , fct =  G.4())
plot(REF_C100_G4, 
     broken = TRUE, gridsize = 100, xlab = "Tempo(dias)", 
     ylab = "Abs", type = "all")
summary(REF_C100_G4)

C76_C100_G4 <- drm(abs~ tempo, data = C76_C100 , fct =  G.4())
plot(C76_C100_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C67_C100_G4 <- drm(abs~ tempo, data = C67_C100 , fct =  G.4())
plot(C67_C100_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C68_C100_G4 <- drm(abs~ tempo, data = C68_C100 , fct =  G.4())
plot(C68_C100_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

# C100 analysis

newdata_REF_C100 <- expand.grid(tempo = seq(min(REF_C100$tempo), max(REF_C100$tempo), length.out = 200))
newdata_REF_C100$abs <- predict(REF_C100_G4, newdata_REF_C100, type = 'response')
newdata_REF_C100$pop <- "REF"

newdata_C76_C100 <- expand.grid(tempo = seq(min(C76_C100$tempo), max(C76_C100$tempo), length.out = 200))
newdata_C76_C100$abs <- predict(C76_C100_G4, newdata_C76_C100, type = 'response')
newdata_C76_C100$pop <- "C76"

newdata_C67_C100 <- expand.grid(tempo = seq(min(C67_C100$tempo), max(C67_C100$tempo), length.out = 200))
newdata_C67_C100$abs <- predict(C67_C100_G4, newdata_C67_C100, type = 'response')
newdata_C67_C100$pop <- "C67"

newdata_C68_C100 <- expand.grid(tempo = seq(min(C68_C100$tempo), max(C68_C100$tempo), length.out = 200))
newdata_C68_C100$abs <- predict(C68_C100_G4, newdata_C68_C100, type = 'response')
...
COEFICIENTS <- c("GrowthRate", "c", "d","e")
modelREF <- summary(REF_C100_G4)
confintREF <- confint(REF_C100_G4)
modelREF_coef <- as.data.frame(modelREF$coefficients)
modelREF_conf <- as.data.frame(confintREF)
modelREF_SUM <- cbind(modelREF_coef, modelREF_conf)
modelREF_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC76 <- summary(C76_C100_G4)
confintC76 <- confint(C76_C100_G4)
modelC76_coef <- as.data.frame(modelC76$coefficients)
modelC76_conf <- as.data.frame(confintC76)
modelC76_SUM <- cbind(modelC76_coef, modelC76_conf)
modelC76_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC67 <- summary(C67_C100_G4)
confintC67 <- confint(C67_C100_G4)
modelC67_coef <- as.data.frame(modelC67$coefficients)
modelC67_conf <- as.data.frame(confintC67)
modelC67_SUM <- cbind(modelC67_coef, modelC67_conf)
modelC67_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC7 <- summary(C68_C100_G4)
confintC7 <- confint(C68_C100_G4)
modelC68_coef <- as.data.frame(modelC7$coefficients)
modelC68_conf <- as.data.frame(confintC7)
modelC68_SUM <- cbind(modelC68_coef, modelC68_conf)
modelC68_SUM$coef <- COEFICIENTS 
...
plot1 <- ggplot(REF_C100, aes(x = fitted(REF_C100_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " REF - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(REF_C100, aes(x = fitted(REF_C100_G4), y = residuals(REF_C100_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "REF - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(REF_C100, aes(sample = residuals(REF_C100_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C76_C100, aes(x = fitted(C76_C100_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C100, aes(x = fitted(C76_C100_G4), y = residuals(C76_C100_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C100, aes(sample = residuals(C76_C100_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C100, aes(x = fitted(C67_C100_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C67_C100, aes(x = fitted(C67_C100_G4), y = residuals(C67_C100_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C67 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C67_C100, aes(sample = residuals(C67_C100_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C68_C100, aes(x = fitted(C68_C100_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C100, aes(x = fitted(C68_C100_G4), y = residuals(C68_C100_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C100, aes(sample = residuals(C68_C100_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
REF_C150_G4 <- drm(abs~tempo, data = REF_C150 , fct =  G.4())
plot(REF_C150_G4, 
     broken = TRUE, gridsize = 100, xlab = "Tempo(dias)", 
     ylab = "Abs", type = "all")
summary(REF_C150_G4)

C76_C150_G4 <- drm(abs~ tempo, data = C76_C150 , fct =  G.4())
plot(C76_C150_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C67_C150_G4 <- drm(abs~ tempo, data = C67_C150 , fct =  G.4())
plot(C67_C150_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")

C68_C150_G4 <- drm(abs~ tempo, data = C68_C150 , fct =  G.4())
plot(C68_C150_G4, broken = TRUE, gridsize = 100, xlab = "Tempo (dias)", 
     ylab = "Abs", type = "all")
...
newdata_C76_C150$abs <- predict(C76_C150_G4, newdata_C76_C150, type = 'response')
...
newdata_C68_C150$abs <- predict(C68_C150_G4, newdata_C68_C150, type = 'response')
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC76 <- summary(C76_C150_G4)
confintC76 <- confint(C76_C150_G4)
modelC76_coef <- as.data.frame(modelC76$coefficients)
modelC76_conf <- as.data.frame(confintC76)
modelC76_SUM <- cbind(modelC76_coef, modelC76_conf)
modelC76_SUM$coef <- COEFICIENTS 
...
COEFICIENTS <-  c("GrowthRate", "c", "d","e")
modelC7 <- summary(C68_C150_G4)
confintC7 <- confint(C68_C150_G4)
modelC68_coef <- as.data.frame(modelC7$coefficients)
modelC68_conf <- as.data.frame(confintC7)
modelC68_SUM <- cbind(modelC68_coef, modelC68_conf)
modelC68_SUM$coef <- COEFICIENTS 
...
plot1 <- ggplot(REF_C150, aes(x = fitted(REF_C150_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " REF - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot1 <- ggplot(C76_C150, aes(x = fitted(C76_C150_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C76 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C76_C150, aes(x = fitted(C76_C150_G4), y = residuals(C76_C150_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C76 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C76_C150, aes(sample = residuals(C76_C150_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C67_C150, aes(x = fitted(C67_C150_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C67 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C67_C150, aes(x = fitted(C67_C150_G4), y = residuals(C67_C150_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C67 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C67_C150, aes(sample = residuals(C67_C150_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
...
plot1 <- ggplot(C68_C150, aes(x = fitted(C68_C150_G4), y = abs)) +
  geom_point(pch = 16, cex = 2) +
  geom_abline(intercept = 0, slope = 1) +
  labs(title = " C68 - G4\nAjustados x Observados", x = "Valores ajustados", 
       y = "Valores observados") +
...
plot2 <- ggplot(C68_C150, aes(x = fitted(C68_C150_G4), y = residuals(C68_C150_G4, type = "studentised"))) +
  geom_point(pch = 16, cex = 2) +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "C68 - G4\nResíduos x Ajustados", x = "Valores ajustados", 
...
plot3 <- ggplot(C68_C150, aes(sample = residuals(C68_C150_G4, type = "studentised"))) +
  geom_qq() +
  geom_qq_line() +
  labs(title = "G4", x = "Quantis teóricos", y = "Resíduos") +
  theme_minimal()+
